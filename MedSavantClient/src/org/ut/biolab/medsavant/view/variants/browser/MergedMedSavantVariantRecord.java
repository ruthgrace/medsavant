 ...
 */
package org.ut.biolab.medsavant.view.variants.browser;
    ...
    public void addRecord(Object[] arr, int index){
        ...
        for(int i = 0; i < gt.length; i++){
            ...
            if(x == 0){
                ...
                participantVariant[i] = convertVariantType(org.ut.biolab.medsavant.vcf.VariantRecord.VariantType.valueOf((String)arr[BasicVariantColumns.INDEX_OF_VARIANT_TYPE]), alts[x-1]);
