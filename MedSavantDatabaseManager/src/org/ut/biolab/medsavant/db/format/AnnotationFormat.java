...
public class AnnotationFormat {
    ...
    public static AnnotationFormat getDefaultAnnotationFormat(){
        ...
        fields.add(new AnnotationField("aa", "VARCHAR(500)", true, "AA", ""));
        fields.add(new AnnotationField("ac", "VARCHAR(500)", true, "AC", ""));
        fields.add(new AnnotationField("af", "VARCHAR(500)", true, "AF", ""));
        fields.add(new AnnotationField("an", "INT(11)", true, "AN", ""));
        fields.add(new AnnotationField("bq", "FLOAT", true, "BQ", ""));
        fields.add(new AnnotationField("cigar", "VARCHAR(500)", false, "Cigar", ""));
        fields.add(new AnnotationField("db", "INT(1)", true, "DB", ""));
        fields.add(new AnnotationField("dp", "INT(11)", true, "DP", ""));
        fields.add(new AnnotationField("end", "VARCHAR(500)", true, "End", ""));
        fields.add(new AnnotationField("h2", "INT(1)", true, "H2", ""));
        fields.add(new AnnotationField("mq", "VARCHAR(500)", true, "MQ", ""));
        fields.add(new AnnotationField("mq0", "VARCHAR(500)", true, "MQ0", ""));
        fields.add(new AnnotationField("ns", "INT(11)", true, "NS", ""));
        fields.add(new AnnotationField("sb", "VARCHAR(500)", true, "SB", ""));
