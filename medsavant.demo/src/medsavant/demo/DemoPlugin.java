 ...
 * @author tarkvara
 */
public class DemoPlugin extends MedSavantSectionPlugin {
    /**
    ...
    public void init(JPanel panel) {
        ...
        gbc.weightx = 1.0;
        gbc.weighty = 1.0;
        panel.add(new JLabel("<html><i>This space intentionally left blank.</i></html>"), gbc);
    }
