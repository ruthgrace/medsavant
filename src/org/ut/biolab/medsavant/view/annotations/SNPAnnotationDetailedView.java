 ...
 * @author mfiume
 */
class SNPAnnotationDetailedView extends DetailedView {
    private final JPanel details;
    private final JPanel menu;
    private final JPanel content;

    public SNPAnnotationDetailedView() {
    ...
    private void setDetailsForAnnotation(String annotationName) {
        if (annotationName.equals(SNPAnnotationListModel.ANNOTATION_GATK)) {
        ...
        } else if (annotationName.equals(SNPAnnotationListModel.ANNOTATION_SIFT)) {
            String[][] kvp = new String[3][2];
            kvp[0][0] = "Description";
            ...
            kvp[2][1] = "Homo Sapiens (hg19 exome)";
            details.add(ViewUtil.getKeyValuePairPanel(kvp),BorderLayout.NORTH);
        } else if (annotationName.equals(SNPAnnotationListModel.ANNOTATION_POLYPHEN)) {
            String[][] kvp = new String[3][2];
            kvp[0][0] = "Description";
